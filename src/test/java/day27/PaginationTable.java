...
public static void main(String[] args) throws InterruptedException {
		...
		//this if loop to check any securtiy popup masseges. this msg popups when any application configaration issues erases
		if(driver.findElement(By.xpath("//button[@class='btn-close']")).isDisplayed())//this xpath is also the path of the popuped window
		{
